...
class CerebrateConfig(PretrainedConfig):
    model_type = 'cerebrate'
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """The Cerebrate configuration class.
    ...
    def _validate_config(self):
        ...
        if (self.decay_weight_ma < 0) or (self.decay_weight_ma > 1):
            raise ValueError('decay_weight_ma must be between 0 and 1')
        if (self.neuron_keep_probability < 0) or (self.neuron_keep_probability > 1):
            raise ValueError('neuron_keep_probability must be between 0 and 1')
        if (self.neuron_keep_steps < 0):
            raise ValueError('neuron_keep_steps must be 0 or positive integer')
        if (self.max_step_size < 1):
            raise ValueError('neuron_keep_steps must be positive integer')
